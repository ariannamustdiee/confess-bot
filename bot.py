...
async def on_ready():
    ...
    if guild_sync_ok:
        # Guild-specific commands are live: clear any leftover global
        # commands so they don't show up as duplicates.
        bot.tree.clear_commands(guild=None)
        await bot.tree.sync()
    else:
        # No guild-specific commands: fall back to a global sync
